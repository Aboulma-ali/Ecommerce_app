    ...
    <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-20">
            ...
            <div class="hidden md:flex flex-1 max-w-xs xl:max-w-lg mx-8 items-center">
                {{-- Composant de recherche Livewire à intégrer ultérieurement --}}
                <div class="relative w-full">
                    <input
                        type="text"
                        placeholder="Rechercher des produits..."
                        class="w-full pl-12 pr-4 py-3 border border-gray-200 rounded-full focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 bg-gray-50 hover:bg-white focus:bg-white shadow-inner focus:shadow-md"
                    >
